            ...
            <div class="wpuf-pp-pricing__head">
                ...
                <div class="wpuf-pp-pricing__toggle-wrap">
                    <div class="wpuf-pp-toggle">
                        <button type="button" class="is-active" data-period="annual" data-suffix="<?php echo esc_attr__( '/year', 'wp-user-frontend' ); ?>"><?php esc_html_e( 'Annual', 'wp-user-frontend' ); ?></button>
                        <button type="button" data-period="lifetime" data-suffix="<?php echo esc_attr__( '/one-time', 'wp-user-frontend' ); ?>"><?php esc_html_e( 'Lifetime', 'wp-user-frontend' ); ?></button>
                    </div>
                    ...
                    <div class="wpuf-pp-plan<?php echo esc_attr( $plan['featured'] ? ' wpuf-pp-plan--featured' : '' ); ?>">
                        <div class="wpuf-pp-plan__top">
                            ...
                            <div class="wpuf-pp-plan__price">
                                ...
                                <span class="wpuf-pp-plan__period"><?php esc_html_e( '/year', 'wp-user-frontend' ); ?></span>
                            </div>
                        </div>
